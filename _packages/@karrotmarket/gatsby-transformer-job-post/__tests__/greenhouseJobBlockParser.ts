...
describe('Greenhouse content block parser', () => {
  it('should parses full content (encoded)', () => {
    const input = stripIndent`
      &lt;div class=&quot;content-intro&quot;&gt;&lt;h3&gt;당근마켓팀 합류 여정에 오르신 것을 진심으로 환영해요&lt;/h3&gt;
      &lt;p&gt;당근마켓은 회사의 성장에 맞춰 개인이 함께 성장할 수 있는 환경을 만들기 위해 노력을 하고 있어요.&amp;nbsp;&lt;/p&gt;
      &lt;p&gt;멋진 동료들과 행복한 고민을 하는 그 순간이 올 수 있도록 당근마켓 채용팀이 도와드릴게요.&lt;/p&gt;
      &lt;hr&gt;
      ...
      &lt;/ul&gt;
      &lt;h4&gt;화상 면접&lt;/h4&gt;
      &lt;p&gt;지원해주신 직무와 업무 연관성이 높은 당근마켓 팀원과 화상으로 직무와 관련된 기본적인 지식에 대해 이야기를 나누는 단계예요.&lt;/p&gt;
      ...
      &lt;h4&gt;직무 면접&lt;/h4&gt;
      &lt;p&gt;지원하신 직무와 업무 연관성이 높은 당근마켓 팀원들과 직무 역량, 경험에 대해 화상 면접보다 심층적인 이야기를 나누는 단계예요.&lt;br&gt;과제가 출제되었을 경우 과제에 대한 질문을 드려요.&lt;/p&gt;
      &lt;h4&gt;컬쳐핏 면접(정규직 공통)&lt;/h4&gt;
      &lt;p&gt;당근마켓은 면접을 단순히 회사에 사람을 뽑는 자리로 생각하지 않아요. 당근마켓과 지원자가 서로 추구하는 가치관과 생각을 교환하는 시간이라고 생각하고 있어요. 컬쳐핏 단계는 당근마켓이 추구하는 문화와 일하는 방식과 잘 어울릴 수 있는 분인지 확인하는 단계예요. 또한 포지션에 대한 전문성을 다시금 확인하는 이야기를 나눠요.&lt;/p&gt;
      &lt;h4&gt;안내사항&lt;/h4&gt;
      &lt;ul&gt;
      ...
      &lt;/ul&gt;
      &lt;p&gt;&amp;nbsp;&lt;/p&gt;
      &lt;p&gt;당근마켓 채용에 대해 궁금한 점이 있으면 언제든지 편하게 문의 주세요 :)&lt;/p&gt;
