...
describe('Greenhouse content block parser', () => {
  it('should parses full content (encoded)', () => {
    const input = stripIndent`
      ...
      &lt;p&gt;당근 팀은 회사의 성장에 맞춰 개인이 함께 성장할 수 있는 환경을 만들기 위해 노력을 하고 있어요.&amp;nbsp;&lt;/p&gt;
      ...
      &lt;h4&gt;컬쳐핏 면접(정규직 공통)&lt;/h4&gt;
      &lt;p&gt;당근 팀은 면접을 단순히 회사에 사람을 뽑는 자리로 생각하지 않아요. 당근과 지원자가 서로 추구하는 가치관과 생각을 교환하는 시간이라고 생각하고 있어요. 컬쳐핏 단계는 당근이 추구하는 문화와 일하는 방식과 잘 어울릴 수 있는 분인지 확인하는 단계예요. 또한 포지션에 대한 전문성을 다시금 확인하는 이야기를 나눠요.&lt;/p&gt;
      &lt;h4&gt;안내사항&lt;/h4&gt;
      &lt;ul&gt;
