...
type PrismicTeamContentsDataMainBodyIllustrationAndDescriptionProps = {
  data: GatsbyTypes.PrismicTeamContentsDataMainBodyIllustrationAndDescription_dataFragment,
  className?: string,
};

export const query = graphql`
  fragment PrismicTeamContentsDataMainBodyIllustrationAndDescription_data on PrismicTeamContentsDataMainBodyIllustrationAndDescription {
    primary {
      illustration {
        alt
        localFile {
...
const PrismicTeamContentsDataMainBodyIllustrationAndDescription: React.FC<
  PrismicTeamContentsDataMainBodyIllustrationAndDescriptionProps
> = ({
  data,
  className,
}) => {
...
export default PrismicTeamContentsDataMainBodyIllustrationAndDescription;
