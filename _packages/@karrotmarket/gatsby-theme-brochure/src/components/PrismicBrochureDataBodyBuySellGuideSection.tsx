...
const ForwardIcon = () => (
  <svg width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M13.4697 21.0303C13.1768 20.7374 13.1768 20.2626 13.4697 19.9697L18.1893 15.25L8 15.25C7.58579 15.25 7.25 14.9142 7.25 14.5C7.25 14.0858 7.58579 13.75 8 13.75L18.1893 13.75L13.4697 9.03033C13.1768 8.73744 13.1768 8.26256 13.4697 7.96967C13.7626 7.67678 14.2374 7.67678 14.5303 7.96967L20.5303 13.9697C20.8232 14.2626 20.8232 14.7374 20.5303 15.0303L14.5303 21.0303C14.2374 21.3232 13.7626 21.3232 13.4697 21.0303Z"
      fill="currentColor"
    />
  </svg>
);
