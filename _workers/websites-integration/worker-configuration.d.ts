/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 25ef95ce1ad2115a03e5f5f79fb6c435)
// Runtime types generated with workerd@1.20251217.0 2025-12-19 
declare namespace Cloudflare {
	interface Env {
		DEPLOYMENT_META: KVNamespace;
		WEBSITES_ADMIN_KEY: string;
		GITHUB_API_TOKEN: string;
		ARTIFACTS: R2Bucket;
		ASSETS: Fetcher;
		DEPLOYMENT_WORKFLOW: Workflow /* DeploymentWorkflow */;
	}
}
