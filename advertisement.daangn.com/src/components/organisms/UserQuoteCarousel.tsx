  ...
  return (
    <Container>
      <SlideCamera {...swipeHandlers}>
        <Slide css={{ '$$slide': slide, display: "none", "@md": {display: "flex"}}}>
        ...
        <Slide css={{ '$$slide': slide, display: "flex", alignItems: 'center', "@md": {display: "none"}}}>
