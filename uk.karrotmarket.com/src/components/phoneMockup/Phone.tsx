...
const BackIcon = () => (
    <svg width={em(26)} height={em(25)} viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
const Phone: React.FC<PhoneProps> = ({ frameColor, header, fontSize, height, align, children }) => {
    return (
        <Wrapper
            css={{
