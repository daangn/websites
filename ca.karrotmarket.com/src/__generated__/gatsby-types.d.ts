...
type SitePluginPluginOptions = {
  ...
  readonly hot_articles_api: Maybe<Scalars['String']>;
...
type Query_allHotArticleArgs = {
  filter: Maybe<HotArticleFilterInput>;
  sort: Maybe<HotArticleSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type SitePluginPluginOptionsFilterInput = {
  ...
  readonly hot_articles_api: Maybe<StringQueryOperatorInput>;
...
type SitePageFieldsEnum =
  ...
  | 'pluginCreator.pluginOptions.hot_articles_api'
...
type HotArticleSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<HotArticleFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type SitePluginFieldsEnum =
  ...
  | 'pluginOptions.hot_articles_api'
...
type PopularSection_articlesFragment = Pick<HotArticle, 'price' | 'region' | 'image' | 'id'>;
...
type IndexPageQueryQuery = (
  ...
  )>, readonly hotArticles: { readonly nodes: ReadonlyArray<PopularSection_articlesFragment> } }
