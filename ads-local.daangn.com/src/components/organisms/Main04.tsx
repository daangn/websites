    ...
    <Section>
      <Container>
        ...
        <ButtonRow>
          ...
          <Pill active={activeTab==='FEED'} onClick={()=>setActiveTab('FEED')}>피드 광고</Pill>
          <Pill active={activeTab==='SEARCH'} onClick={()=>setActiveTab('SEARCH')}>검색 광고</Pill>
        </ButtonRow>
          ...
          {activeTab === 'FEED' && (
            <ContentArea>
              ...
              <DescriptionContainer>
                ...
                <Description>
                선택한 동네 홈 피드에 광고를 노출하는 상품이에요.<br />
                ...
                <OutlinedButton id='guide-feed' onClick={()=>window.open('https://daangnbiz.oopy.io/8c64a37b-b0e3-4ac0-ad3c-482b345ca37b', '_blank')}>
                  피드 광고 가이드 바로가기
                </OutlinedButton>
              </DescriptionContainer>
            </ContentArea>
        ...
        {activeTab === 'SEARCH' && (
            <ContentArea>
              ...
              <DescriptionContainer>
                ...
                <OutlinedButton id='guide-search' onClick={()=>window.open('https://daangnbiz.oopy.io/8a6e149e-f077-4970-a533-ce835978ee9c','_blank')}>
                  검색 광고 가이드 바로가기
                </OutlinedButton>
              </DescriptionContainer>
            </ContentArea>
