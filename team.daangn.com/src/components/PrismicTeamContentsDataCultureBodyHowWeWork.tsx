...
export const query = graphql`
  fragment PrismicTeamContentsDataCultureBodyHowWeWork_data on PrismicTeamContentsDataCultureBodyHowWeWork {
    primary {
      title {
        text
      }
...
const PrismicTeamContentsDataCultureBodyHowWeWork: React.FC<PrismicTeamContentsDataCultureBodyHowWeWorkProps> = ({
  data,
}) => {
...
export default PrismicTeamContentsDataCultureBodyHowWeWork;
