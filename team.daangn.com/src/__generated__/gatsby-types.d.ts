...
type JobCorporateQueryOperatorInput = {
  readonly eq: InputMaybe<JobCorporate>;
  readonly in: InputMaybe<ReadonlyArray<InputMaybe<JobCorporate>>>;
  readonly ne: InputMaybe<JobCorporate>;
  readonly nin: InputMaybe<ReadonlyArray<InputMaybe<JobCorporate>>>;
};
...
type JobPostFilterInput = {
  ...
  readonly corporate: InputMaybe<JobCorporateQueryOperatorInput>;
...
type Query_jobPostArgs = {
  ...
  corporate: InputMaybe<JobCorporateQueryOperatorInput>;
...
type TeamWebsite_DefaultLayout_queryFragment = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null };

type Header_navigationDataFragment = { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null };

type NavigationMenu_dataFragment = { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null };

type SocialServiceProfile_profileFragment = { readonly service: string | null, readonly link: { readonly url: string | null } | null };

type Footer_navigationDataFragment = { readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null };

type AllLokaliseMessagesFragment = { readonly detail_link__default_label: string | null, readonly form_field__empty_placeholder: string | null, readonly form_field__no_placeholder: string | null, readonly form_field__organization_name: string | null, readonly form_field__placeholder: string | null, readonly form_field__yes_placeholder: string | null, readonly job_application_page__alert_completed: string | null, readonly job_application_page__alert_failed: string | null, readonly job_application_page__button_submit: string | null, readonly job_application_page__confirm_apply: string | null, readonly job_application_page__field_email_label: string | null, readonly job_application_page__field_email_placeholder: string | null, readonly job_application_page__field_file_placeholder: string | null, readonly job_application_page__field_name_label: string | null, readonly job_application_page__field_name_placeholder: string | null, readonly job_application_page__field_phone_label: string | null, readonly job_application_page__field_phone_placeholder: string | null, readonly job_application_page__field_portpolio_description: string | null, readonly job_application_page__field_portpolio_label: string | null, readonly job_application_page__field_portpolio_placeholder: string | null, readonly job_application_page__field_resume_description: string | null, readonly job_application_page__field_resume_label: string | null, readonly job_application_page__field_resume_placeholder: string | null, readonly job_application_page__terms_privacy_info: string | null, readonly job_application_page__terms_sensitive_info: string | null, readonly job_post_layout__prior_experience_no: string | null, readonly job_post_layout__prior_experience_whatever: string | null, readonly job_post_layout__prior_experience_yes: string | null, readonly job_post_layout__property_karrot_market: string | null, readonly job_post_layout__property_karrot_pay: string | null, readonly job_post_layout__tab_apply: string | null, readonly job_post_layout__tab_view: string | null, readonly job_post_list__empty_placeholder__back_to_list: string | null, readonly job_post_list__empty_placeholder__no_results: string | null, readonly job_post_page__back_to_list: string | null, readonly job_post_page__external_post_link: string | null, readonly job_post_page__external_post_notice: string | null, readonly job_post_page__faq: string | null, readonly jobs_page__corporate_all: string | null, readonly jobs_page__KARROT_MARKET: string | null, readonly jobs_page__KARROT_PAY: string | null, readonly jobs_page__chapter_all: string | null, readonly jobs_page__default_meta_title: string | null, readonly jobs_page__employment_type_all: string | null, readonly jobs_page__employment_type_assistant: string | null, readonly jobs_page__employment_type_contractor: string | null, readonly jobs_page__employment_type_fulltime: string | null, readonly jobs_page__employment_type_intern: string | null, readonly jobs_page__search: string | null, readonly faq_page__search: string | null };

type PrismicTeamContentsDataCultureBodyKeyVisual_dataFragment = { readonly primary: { readonly expanded: boolean | null, readonly key_visual_image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly thumbnails: { readonly portrait: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null } | null, readonly description: { readonly text: string | null } | null } };

type PrismicTeamContentsDataCultureBodyWideBanner_dataFragment = { readonly primary: { readonly background_color: string | null, readonly link_text: string | null, readonly title: { readonly text: string | null } | null, readonly thumbnail: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly link: { readonly url: string | null } | null } };

type PrismicTeamContentsDataCultureBodyHowWeWork_dataFragment = { readonly primary: { readonly title: { readonly text: string | null } | null }, readonly items: ReadonlyArray<{ readonly group: string | null, readonly key_text: string | null, readonly description: { readonly text: string | null } | null }> };

type PrismicTeamContentsDataCultureBodyBenefit_dataFragment = { readonly primary: { readonly title: { readonly text: string | null } | null }, readonly items: ReadonlyArray<{ readonly subtitle: string | null, readonly subtext: string | null, readonly description: { readonly html: string | null } | null }> };

type PrismicTeamContentsDataCultureBodyIllustrationAndDescription_dataFragment = { readonly primary: { readonly expanded: boolean | null, readonly inverted: boolean | null, readonly link_text: string | null, readonly illustration: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly description: { readonly text: string | null } | null, readonly link: { readonly url: string | null } | null } };

type PrismicTeamContentsDataCultureBodyTitleAndDescription_dataFragment = { readonly primary: { readonly key_text: string | null, readonly inverted: boolean | null, readonly title: { readonly text: string | null } | null, readonly description: { readonly html: string | null } | null, readonly link: { readonly url: string | null } | null } };

type PrismicTeamContentsDataCultureBodyTitleAndIllustration_dataFragment = { readonly primary: { readonly key_text: string | null, readonly inverted: boolean | null, readonly title: { readonly text: string | null } | null, readonly illustration: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly link: { readonly url: string | null } | null } };

type TeamWebsite_FaqAccordion_faqDataFragment = { readonly entries: ReadonlyArray<{ readonly question: string | null, readonly answer: { readonly text: string | null, readonly html: string | null } | null } | null> | null };

type TeamWebsite_FaqAccordionItem_entryFragment = { readonly question: string | null, readonly answer: { readonly text: string | null, readonly html: string | null } | null };

type PrismicTeamContentsDataMainBodyKeyVisual_dataFragment = { readonly primary: { readonly expanded: boolean | null, readonly key_visual_image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly thumbnails: { readonly portrait: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null } | null, readonly description: { readonly text: string | null } | null } };

type PrismicTeamContentsDataMainBodyMemberQuoteCarousel_dataFragment = { readonly items: ReadonlyArray<{ readonly quote: string | null, readonly who: string | null, readonly image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> };

type TeamWebsite_CarouselItem_itemFragment = { readonly quote: string | null, readonly who: string | null, readonly image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null };

type PrismicTeamContentsDataMainBodyTitleAndDescription_dataFragment = { readonly primary: { readonly key_text: string | null, readonly inverted: boolean | null, readonly title: { readonly text: string | null } | null, readonly description: { readonly html: string | null } | null, readonly link: { readonly url: string | null } | null } };

type PrismicTeamContentsDataMainBodyTitleAndIllustration_dataFragment = { readonly primary: { readonly key_text: string | null, readonly inverted: boolean | null, readonly title: { readonly text: string | null } | null, readonly illustration: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly link: { readonly url: string | null } | null } };

type PrismicTeamContentsDataMainBodyIllustrationAndDescription_dataFragment = { readonly primary: { readonly expanded: boolean | null, readonly inverted: boolean | null, readonly link_text: string | null, readonly illustration: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly description: { readonly text: string | null } | null, readonly link: { readonly url: string | null } | null } };

type PrismicTeamContentsDataMainBodyWideBanner_dataFragment = { readonly primary: { readonly background_color: string | null, readonly link_text: string | null, readonly title: { readonly text: string | null } | null, readonly thumbnail: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly link: { readonly url: string | null } | null } };

type PrismicTeamContentsDataMainBodyHowWeWork_dataFragment = { readonly primary: { readonly title: { readonly text: string | null } | null }, readonly items: ReadonlyArray<{ readonly group: string | null, readonly key_text: string | null, readonly description: { readonly text: string | null } | null }> };

type PrismicTeamContentsDataMainBodyBenefit_dataFragment = { readonly primary: { readonly title: { readonly text: string | null } | null }, readonly items: ReadonlyArray<{ readonly subtitle: string | null, readonly subtext: string | null, readonly description: { readonly html: string | null } | null }> };

type TeamWebsite_JobPostLayout_queryFragment = { readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly jobs_page_meta_title: string | null, readonly jobs_page_meta_description: string | null, readonly jobs_page_meta_image: { readonly localFile: { readonly childImageSharp: { readonly fixed: { readonly src: string, readonly width: number, readonly height: number } | null } | null } | null } | null, readonly jobs_page_title: { readonly text: string | null } | null } } | null, readonly jobPost: { readonly id: string, readonly ghId: string, readonly title: string, readonly corporate: JobCorporate | null, readonly employmentType: JobEmploymentType, readonly priorExperience: JobPriorExperience, readonly externalUrl: string | null, readonly validThrough: string | null, readonly datePosted: string } | null };

type TeamWebsite_JobPostingJsonLd_jobPostFragment = { readonly title: string, readonly validThrough: string | null, readonly priorExperience: JobPriorExperience, readonly corporate: JobCorporate | null, readonly datePosted: string };

type TeamWebsite_JobPostContentSection_contentFragment = { readonly title: string, readonly bodyHtml: string };

type TeamWebsite_JobPostList_jobPostsFragment = { readonly id: string, readonly ghId: string, readonly externalUrl: string | null, readonly order: number, readonly employmentType: JobEmploymentType, readonly title: string, readonly chapter: string, readonly corporate: JobCorporate | null, readonly priorExperience: JobPriorExperience, readonly tags: ReadonlyArray<string>, readonly departments: ReadonlyArray<{ readonly id: string }> };

type TeamWebsite_JobPostSummary_jobPostFragment = { readonly id: string, readonly title: string, readonly chapter: string, readonly corporate: JobCorporate | null, readonly employmentType: JobEmploymentType, readonly priorExperience: JobPriorExperience, readonly tags: ReadonlyArray<string> };

type PrismicTeamContentsDataLifeBodyLifeContent_dataFragment = { readonly primary: { readonly title: { readonly text: string | null } | null, readonly body_text: { readonly html: string | null } | null }, readonly items: ReadonlyArray<{ readonly thumbnail_description: { readonly text: string | null } | null, readonly thumbnail_image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> };
...
type BannerAreaStaticQuery = { readonly prismicTeamBanner: { readonly data: { readonly __typename: 'PrismicTeamBannerDataType', readonly background_color: string | null, readonly image_360: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly image_576: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly image_768: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly href: { readonly id: string | null, readonly url: string | null } | null } } | null };
...
type IrListPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly allPrismicIr: { readonly nodes: ReadonlyArray<{ readonly uid: string, readonly first_publication_date: string, readonly data: { readonly title: { readonly text: string | null } | null } }> } };
...
type IrPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly prismicIr: { readonly uid: string, readonly first_publication_date: string, readonly data: { readonly title: { readonly text: string | null } | null, readonly attachment_group: ReadonlyArray<{ readonly file: { readonly localFileFixed: { readonly base: string, readonly publicURL: string | null } | null } | null } | null> | null, readonly body: ReadonlyArray<{ readonly __typename: 'PrismicIrDataBodyMainText', readonly id: string, readonly primary: { readonly text: { readonly html: string | null } | null } } | { readonly __typename: 'PrismicIrDataBodySupplementaryText', readonly id: string, readonly primary: { readonly text: { readonly html: string | null } | null } }> } } | null };

type LokaliseTranslationQueryVariables = Exact<{ [key: string]: never; }>;


type LokaliseTranslationQuery = { readonly lokaliseTranslation: { readonly messages: { readonly detail_link__default_label: string | null, readonly form_field__empty_placeholder: string | null, readonly form_field__no_placeholder: string | null, readonly form_field__organization_name: string | null, readonly form_field__placeholder: string | null, readonly form_field__yes_placeholder: string | null, readonly job_application_page__alert_completed: string | null, readonly job_application_page__alert_failed: string | null, readonly job_application_page__button_submit: string | null, readonly job_application_page__confirm_apply: string | null, readonly job_application_page__field_email_label: string | null, readonly job_application_page__field_email_placeholder: string | null, readonly job_application_page__field_file_placeholder: string | null, readonly job_application_page__field_name_label: string | null, readonly job_application_page__field_name_placeholder: string | null, readonly job_application_page__field_phone_label: string | null, readonly job_application_page__field_phone_placeholder: string | null, readonly job_application_page__field_portpolio_description: string | null, readonly job_application_page__field_portpolio_label: string | null, readonly job_application_page__field_portpolio_placeholder: string | null, readonly job_application_page__field_resume_description: string | null, readonly job_application_page__field_resume_label: string | null, readonly job_application_page__field_resume_placeholder: string | null, readonly job_application_page__terms_privacy_info: string | null, readonly job_application_page__terms_sensitive_info: string | null, readonly job_post_layout__prior_experience_no: string | null, readonly job_post_layout__prior_experience_whatever: string | null, readonly job_post_layout__prior_experience_yes: string | null, readonly job_post_layout__property_karrot_market: string | null, readonly job_post_layout__property_karrot_pay: string | null, readonly job_post_layout__tab_apply: string | null, readonly job_post_layout__tab_view: string | null, readonly job_post_list__empty_placeholder__back_to_list: string | null, readonly job_post_list__empty_placeholder__no_results: string | null, readonly job_post_page__back_to_list: string | null, readonly job_post_page__external_post_link: string | null, readonly job_post_page__external_post_notice: string | null, readonly job_post_page__faq: string | null, readonly jobs_page__corporate_all: string | null, readonly jobs_page__KARROT_MARKET: string | null, readonly jobs_page__KARROT_PAY: string | null, readonly jobs_page__chapter_all: string | null, readonly jobs_page__default_meta_title: string | null, readonly jobs_page__employment_type_all: string | null, readonly jobs_page__employment_type_assistant: string | null, readonly jobs_page__employment_type_contractor: string | null, readonly jobs_page__employment_type_fulltime: string | null, readonly jobs_page__employment_type_intern: string | null, readonly jobs_page__search: string | null, readonly faq_page__search: string | null } } | null };
...
type TeamWebsite_CompletedPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly completed_page_content: { readonly html: string | null } | null, readonly completed_page_link_group: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null };
...
type TeamWebsite_CulturePageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly culture_page_meta_title: string | null, readonly culture_page_meta_description: string | null, readonly culture_page_meta_image: { readonly localFile: { readonly childImageSharp: { readonly fixed: { readonly src: string, readonly width: number, readonly height: number } | null } | null } | null } | null, readonly culture_page_title: { readonly text: string | null } | null, readonly culture_body: ReadonlyArray<{ readonly __typename: 'PrismicTeamContentsDataCultureBodyBenefit', readonly primary: { readonly title: { readonly text: string | null } | null }, readonly items: ReadonlyArray<{ readonly subtitle: string | null, readonly subtext: string | null, readonly description: { readonly html: string | null } | null }> } | { readonly __typename: 'PrismicTeamContentsDataCultureBodyDivider' } | { readonly __typename: 'PrismicTeamContentsDataCultureBodyHowWeWork', readonly primary: { readonly title: { readonly text: string | null } | null }, readonly items: ReadonlyArray<{ readonly group: string | null, readonly key_text: string | null, readonly description: { readonly text: string | null } | null }> } | { readonly __typename: 'PrismicTeamContentsDataCultureBodyIllustrationAndDescription', readonly primary: { readonly expanded: boolean | null, readonly inverted: boolean | null, readonly link_text: string | null, readonly illustration: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly description: { readonly text: string | null } | null, readonly link: { readonly url: string | null } | null } } | { readonly __typename: 'PrismicTeamContentsDataCultureBodyKeyVisual', readonly primary: { readonly expanded: boolean | null, readonly key_visual_image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly thumbnails: { readonly portrait: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null } | null, readonly description: { readonly text: string | null } | null } } | { readonly __typename: 'PrismicTeamContentsDataCultureBodyMemberQuoteCarousel' } | { readonly __typename: 'PrismicTeamContentsDataCultureBodyTitleAndDescription', readonly primary: { readonly key_text: string | null, readonly inverted: boolean | null, readonly title: { readonly text: string | null } | null, readonly description: { readonly html: string | null } | null, readonly link: { readonly url: string | null } | null } } | { readonly __typename: 'PrismicTeamContentsDataCultureBodyTitleAndIllustration', readonly primary: { readonly key_text: string | null, readonly inverted: boolean | null, readonly title: { readonly text: string | null } | null, readonly illustration: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly link: { readonly url: string | null } | null } } | { readonly __typename: 'PrismicTeamContentsDataCultureBodyWideBanner', readonly primary: { readonly background_color: string | null, readonly link_text: string | null, readonly title: { readonly text: string | null } | null, readonly thumbnail: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly link: { readonly url: string | null } | null } }> } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null };
...
type TeamWebsite_FaqPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly faq_page_meta_title: string | null, readonly faq_page_meta_description: string | null, readonly faq_page_title: { readonly text: string | null } | null, readonly faq_page_entries: ReadonlyArray<{ readonly faq_category_title: string | null, readonly faq_page: { readonly id: string | null, readonly uid: string | null, readonly document: { readonly data: { readonly display_name: string | null } } | {} | null } | null } | null> | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly prismicFaq: { readonly uid: string, readonly data: { readonly entries: ReadonlyArray<{ readonly question: string | null, readonly keywords: string | null, readonly answer: { readonly text: string | null, readonly html: string | null } | null } | null> | null } } | null };
...
type TeamWebsite_IndexPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly main_page_meta_title: string | null, readonly main_page_meta_description: string | null, readonly main_page_meta_image: { readonly localFile: { readonly childImageSharp: { readonly fixed: { readonly src: string, readonly width: number, readonly height: number } | null } | null } | null } | null, readonly main_page_title: { readonly text: string | null } | null, readonly main_body: ReadonlyArray<{ readonly __typename: 'PrismicTeamContentsDataMainBodyBenefit', readonly primary: { readonly title: { readonly text: string | null } | null }, readonly items: ReadonlyArray<{ readonly subtitle: string | null, readonly subtext: string | null, readonly description: { readonly html: string | null } | null }> } | { readonly __typename: 'PrismicTeamContentsDataMainBodyDivider' } | { readonly __typename: 'PrismicTeamContentsDataMainBodyHowWeWork', readonly primary: { readonly title: { readonly text: string | null } | null }, readonly items: ReadonlyArray<{ readonly group: string | null, readonly key_text: string | null, readonly description: { readonly text: string | null } | null }> } | { readonly __typename: 'PrismicTeamContentsDataMainBodyIllustrationAndDescription', readonly primary: { readonly expanded: boolean | null, readonly inverted: boolean | null, readonly link_text: string | null, readonly illustration: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly description: { readonly text: string | null } | null, readonly link: { readonly url: string | null } | null } } | { readonly __typename: 'PrismicTeamContentsDataMainBodyKeyVisual', readonly primary: { readonly expanded: boolean | null, readonly key_visual_image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly thumbnails: { readonly portrait: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null } | null, readonly description: { readonly text: string | null } | null } } | { readonly __typename: 'PrismicTeamContentsDataMainBodyMemberQuoteCarousel', readonly items: ReadonlyArray<{ readonly quote: string | null, readonly who: string | null, readonly image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> } | { readonly __typename: 'PrismicTeamContentsDataMainBodyTitleAndDescription', readonly primary: { readonly key_text: string | null, readonly inverted: boolean | null, readonly title: { readonly text: string | null } | null, readonly description: { readonly html: string | null } | null, readonly link: { readonly url: string | null } | null } } | { readonly __typename: 'PrismicTeamContentsDataMainBodyTitleAndIllustration', readonly primary: { readonly key_text: string | null, readonly inverted: boolean | null, readonly title: { readonly text: string | null } | null, readonly illustration: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly link: { readonly url: string | null } | null } } | { readonly __typename: 'PrismicTeamContentsDataMainBodyWideBanner', readonly primary: { readonly background_color: string | null, readonly link_text: string | null, readonly title: { readonly text: string | null } | null, readonly thumbnail: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly link: { readonly url: string | null } | null } }> } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null };
...
type TeamWebsite_JobApplicationPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly jobs_page_meta_title: string | null, readonly jobs_page_meta_description: string | null, readonly jobs_page_meta_image: { readonly localFile: { readonly childImageSharp: { readonly fixed: { readonly src: string, readonly width: number, readonly height: number } | null } | null } | null } | null, readonly jobs_page_title: { readonly text: string | null } | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly jobPost: { readonly title: string, readonly validThrough: string | null, readonly priorExperience: JobPriorExperience, readonly corporate: JobCorporate | null, readonly id: string, readonly ghId: string, readonly employmentType: JobEmploymentType, readonly externalUrl: string | null, readonly boardToken: string, readonly datePosted: string, readonly parentJob: { readonly questions: ReadonlyArray<{ readonly __typename: 'GreenhouseJobBoardJobQuestionForAttachment', readonly name: string, readonly label: string, readonly required: boolean, readonly description: string | null } | { readonly __typename: 'GreenhouseJobBoardJobQuestionForLongText', readonly name: string, readonly label: string, readonly required: boolean, readonly description: string | null } | { readonly __typename: 'GreenhouseJobBoardJobQuestionForMultiSelect', readonly name: string, readonly label: string, readonly required: boolean, readonly description: string | null, readonly options: ReadonlyArray<{ readonly label: string, readonly value: string }> } | { readonly __typename: 'GreenhouseJobBoardJobQuestionForShortText', readonly name: string, readonly label: string, readonly required: boolean, readonly description: string | null } | { readonly __typename: 'GreenhouseJobBoardJobQuestionForSingleSelect', readonly name: string, readonly label: string, readonly required: boolean, readonly description: string | null, readonly options: ReadonlyArray<{ readonly label: string, readonly value: string }> } | { readonly __typename: 'GreenhouseJobBoardJobQuestionForYesNo', readonly name: string, readonly label: string, readonly required: boolean, readonly description: string | null, readonly options: ReadonlyArray<{ readonly label: string, readonly value: string }> }> } } | null, readonly privacyPolicy: { readonly id: string, readonly data: { readonly content: { readonly html: string | null } | null } } | null, readonly sensitiveInfoPolicy: { readonly id: string, readonly data: { readonly content: { readonly html: string | null } | null } } | null };
...
type TeamWebsite_JobPostPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly jobs_page_meta_title: string | null, readonly jobs_page_meta_description: string | null, readonly jobs_page_meta_image: { readonly localFile: { readonly childImageSharp: { readonly fixed: { readonly src: string, readonly width: number, readonly height: number } | null } | null } | null } | null, readonly jobs_page_title: { readonly text: string | null } | null, readonly faq_page_entries: ReadonlyArray<{ readonly faq_page: { readonly uid: string | null } | null } | null> | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly jobPost: { readonly title: string, readonly validThrough: string | null, readonly priorExperience: JobPriorExperience, readonly corporate: JobCorporate | null, readonly id: string, readonly ghId: string, readonly employmentType: JobEmploymentType, readonly externalUrl: string | null, readonly datePosted: string, readonly content: ReadonlyArray<{ readonly title: string, readonly bodyHtml: string }> } | null };
...
type TeamWebsite_JobsPageTemplateQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly jobs_page_meta_title: string | null, readonly jobs_page_meta_description: string | null, readonly jobs_page_meta_image: { readonly localFile: { readonly childImageSharp: { readonly fixed: { readonly src: string, readonly width: number, readonly height: number } | null } | null } | null } | null, readonly jobs_page_title: { readonly text: string | null } | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly currentJobDepartment: { readonly name: string } | null, readonly allDepartmentFilteredJobPost: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly ghId: string, readonly externalUrl: string | null, readonly order: number, readonly employmentType: JobEmploymentType, readonly title: string, readonly chapter: string, readonly corporate: JobCorporate | null, readonly priorExperience: JobPriorExperience, readonly tags: ReadonlyArray<string>, readonly absoluteUrl: string, readonly departments: ReadonlyArray<{ readonly id: string }> }> }, readonly allJobDepartment: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly name: string, readonly slug: string | null, readonly jobPosts: ReadonlyArray<{ readonly id: string, readonly corporate: JobCorporate | null }> }> }, readonly allJobPost: { readonly totalCount: number, readonly nodes: ReadonlyArray<{ readonly corporate: JobCorporate | null }> } };
...
type TeamWebsite_LifePageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly life_page_meta_title: string | null, readonly life_page_meta_description: string | null, readonly life_page_meta_image: { readonly localFile: { readonly childImageSharp: { readonly fixed: { readonly src: string, readonly width: number, readonly height: number } | null } | null } | null } | null, readonly life_page_title: { readonly text: string | null } | null, readonly life_body: ReadonlyArray<{ readonly __typename: 'PrismicTeamContentsDataLifeBodyKeyVisual' } | { readonly __typename: 'PrismicTeamContentsDataLifeBodyLifeContent', readonly primary: { readonly title: { readonly text: string | null } | null, readonly body_text: { readonly html: string | null } | null }, readonly items: ReadonlyArray<{ readonly thumbnail_description: { readonly text: string | null } | null, readonly thumbnail_image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> }> } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null };
...
type TeamWebsite_NotFoundPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null, readonly notfound_page_title: { readonly text: string | null } | null, readonly notfound_page_link_group: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null };
...
type TeamWebsite_PreviewResolverPageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null };
...
type TeamWebsite_TeamsArticlePageQuery = { readonly site: { readonly siteMetadata: { readonly locale: string } } | null, readonly prismicTeamContents: { readonly _previewable: string, readonly data: { readonly fb_app_id: string | null, readonly twitter_site_handle: string | null } } | null, readonly prismicSiteNavigation: { readonly _previewable: string, readonly data: { readonly header_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly sns_profiles: ReadonlyArray<{ readonly service: string | null, readonly link: { readonly url: string | null } | null } | null> | null, readonly copyright: { readonly html: string | null } | null, readonly contact_group: ReadonlyArray<{ readonly contact_info: { readonly html: string | null } | null } | null> | null, readonly footer_entries: ReadonlyArray<{ readonly display_text: string | null, readonly link: { readonly url: string | null } | null } | null> | null } } | null, readonly prismicTeamsArticle: { readonly _previewable: string, readonly data: { readonly page_meta_title: string | null, readonly page_meta_description: string | null, readonly page_meta_image: { readonly localFile: { readonly childImageSharp: { readonly fixed: { readonly src: string, readonly width: number, readonly height: number } | null } | null } | null } | null, readonly page_title: { readonly text: string | null } | null, readonly body: ReadonlyArray<{ readonly __typename: 'PrismicTeamsArticleDataBodyArticleSection', readonly primary: { readonly title: { readonly text: string | null } | null, readonly body_text: { readonly html: string | null } | null }, readonly items: ReadonlyArray<{ readonly thumbnail_description: { readonly text: string | null } | null, readonly thumbnail_image: { readonly alt: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> }> } } | null };

type UseFlexSearchIndexStaticQueryVariables = Exact<{ [key: string]: never; }>;


type UseFlexSearchIndexStaticQuery = { readonly localSearchJobPosts: { readonly publicIndexURL: string } | null };

type UseSiteMetadataStaticQueryVariables = Exact<{ [key: string]: never; }>;


type UseSiteMetadataStaticQuery = { readonly site: { readonly siteMetadata: { readonly siteUrl: string } } | null };
